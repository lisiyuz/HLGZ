<template>
  <section class="wrapper">
    <header>
      <section class="nav-btn left">
        <a href="javascript:;" class="react back" @click.prevent="MineBack">
          <img
      ...
      <div class="right">
        <a href="javascript:;" class="reacthome" @click.prevent="MineBack">
          <img
            src="../../assets/images/142ba119b889881105236ef57446e6bf866.png"
            alt
            class="icn_home"
          />
        </a>
        <a href="javascript:;" class="reactsearch" @click.prevent="backSearch">
          <img
            src="../../assets/images/4b45dc09c35f9175498345f8672d08991022.png"
            alt
            class="icn_search"
          />
        </a>
    ...
    <main>
      <a href class="my-account" @click.prevent="signOut">
        <img src="../../assets/images/my-photo.png" alt />
        <img class="avater" src="../../assets/images/pic-default.png" alt />
        <div class="user-info">
          <p class="uname">
            kDk444601767
      ...
      <dl class="list">
        ...
        <dd>
          ...
          >
            <div class="more more-weak gai">
              <i
                class="yanse text-icon order-lottery order-icon iconfont icon-choujiangdan"
    ...
    <Homecomh class="footer-all"></Homecomh>
  </section>
</template>
...
export default {
  ...
  methods: {
        signOut(){
      this.$router.push({path:'Mine/MineDd'});
        },
        gOrder(){
        this.$router.push({ path: 'Mine/allOrder'});
    },
    MineBack() {
      this.$router.push("/Home");
    },
    submitMineDd(){
        this.$router.push({ path: '/MineDd'})
    },
    backSearch(){
          this.$router.push({path:'/Mine/MineSearch'});
    }
  },
  components: {
    Homecomh
...
.level-icon {
  ...
  width: 0.3rem;
  height: 0.3rem;
  background: url(../../assets/images/vip3.png);
...
dl.list {
  height: 2.5rem;
  border-top: 0.01rem solid #ddd8ce;
  border-bottom: 0rem #c0bbb200;
  margin-top: 0.2rem;
  margin-bottom: 0;
  background-color: #fff;
  /* box-shadow: 0.01rem 0.01rem 0.01rem  rgba(102, 102, 102, 0.102); */
}
dl.list dt,
dl.list dd {
  margin: 0;
